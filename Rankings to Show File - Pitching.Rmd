---
title: "2022 Pitching 5x5 Projections"
date: "`r Sys.Date()`"
output: 
  html_notebook:
    theme: cerulean
...
# **Pitching** {.tabset .tabset-pills}   
Players that have an `NA` for `Model_Score` did not play in the MLB in 2021 and have a negative or zero Position Rank. The pitching model had a R-Squared of 0.71. 
```{r}
### Fill in code
```
