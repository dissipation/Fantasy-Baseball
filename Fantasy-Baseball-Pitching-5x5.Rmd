...
### 2021 Player Rankings - Top Worth Players
...
total_treated_2021_pitching <- vtreat::prepare(treat_plan_2021, as.data.frame(DT_pitcher2))
...
names(variables_to_keep_2022_nolag)
