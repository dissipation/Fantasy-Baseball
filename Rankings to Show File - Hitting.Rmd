---
title: "2022 Hitting 5x5 Projections"
date: "`r Sys.Date()`"
output: 
  html_notebook:
    theme: cerulean
...
# **Hitters** {.tabset .tabset-pills}   
Players that have an `NA` for `Model_Score` did not play in the MLB in 2021 and have a negative or zero Position Rank. The hittting model had a R-Squared of 0.91. 
```{r}
### Fill in code
```
